"use client";
/* ============================================================
   SWARM — Dashboard (API usage & cost)
   ============================================================ */
import { useState, type ReactNode } from "react";
import { Icon, Btn, Badge, Card, Bar, StatusDot, Segmented } from "./ui";
import { USAGE, HISTORY } from "./data";
...
export function Dashboard({ onOpenSession }: { onOpenSession: (id: string) => void }) {
      ...
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        <Card style={{ padding: 0, overflow: "hidden" }}>
          ...
          {HISTORY.map((p, i) => {
            ...
            return (
              <button key={p.id} onClick={() => onOpenSession(p.id)} style={{
